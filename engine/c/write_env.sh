...
COLI_VLLM_ENV=PORT=8082 HOST=127.0.0.1 CTX=long MAX_LEN=131072 SPEC=mtp PREFIX_CACHE=1 MAX_SEQS=1 VISION=1 VLLM_SERVER_DEV_MODE=1 'EXTRA_ARGS=--limit-mm-per-prompt {"image":{"count":4}}'
COLI_VLLM_IMAGES=4
