const zhTW: Record<string, string> = {
  ...
  "tier.vram": "VRAM",
  "tier.mmap": "記憶體映射 NVMe（RAM）",
  "tier.mmapAriaLabel": "記憶體映射容器駐留 RAM：{{res}} / {{total}} GB",
  "tier.disk": "磁碟",
  "tier.ariaLabel": "專家分佈：{{vram}} VRAM、{{disk}} 記憶體映射",
  ...
  "hero.title": "AI-DER 引擎",
  "hero.subtitle": "分散式印痕。",
  "hero.tagline": "本機速度。",
  "hero.description": "連線到本地 AI-DER 伺服器，直接從你的硬體串流取得回應。所有資料都留在你選擇的端點內。",
  ...
  "chat.placeholder": "傳送訊息給 AI-DER…",
  "prep.prefix": "引擎準備中：正在計算未見過的穩定前綴",
  "prep.prompt": "正在預填充提示",
  "prep.progress": "{{done}} / {{total}} 個 token · {{rate}} tok/s · 剩餘約 {{eta}}",
  "prep.restored": "{{n}} 個來自快取",
  "prep.waiting": "等待引擎…",
  ...
  "error.title": "AI-DER 介面遇到錯誤",
  "error.hint": "引擎不受影響。請嘗試重新整理頁面。",
  "error.retry": "重試",
  // attribution
  "attribution.link": "致謝與歸屬",
  "attribution.title": "致謝與歸屬",
  "attribution.intro": "AI-DER 建立在他人的工作之上。以下列出本執行環境所依賴的專案、模型與研究。",
  "attribution.close": "關閉",
