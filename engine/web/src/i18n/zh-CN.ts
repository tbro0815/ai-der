const zhCN: Record<string, string> = {
  ...
  "tier.vram": "VRAM",
  "tier.mmap": "内存映射 NVMe（RAM）",
  "tier.mmapAriaLabel": "内存映射容器驻留 RAM：{{res}} / {{total}} GB",
  "tier.disk": "磁盘",
  "tier.ariaLabel": "专家分布：{{vram}} VRAM、{{disk}} 内存映射",
  ...
  "hero.subtitle": "分布式印迹。",
  "hero.tagline": "本地速度。",
  "hero.description": "连接到本地 AI-DER 服务器，直接从你的硬件流式获取响应。所有数据都留在你选择的端点内。",
  ...
  "chat.placeholder": "给 AI-DER 发消息…",
  "prep.prefix": "引擎准备中：正在计算未见过的稳定前缀",
  "prep.prompt": "正在预填充提示",
  "prep.progress": "{{done}} / {{total}} 个 token · {{rate}} tok/s · 剩余约 {{eta}}",
  "prep.restored": "{{n}} 个来自缓存",
  "prep.waiting": "等待引擎…",
  ...
  "error.title": "AI-DER 界面遇到错误",
  "error.hint": "引擎不受影响。请尝试刷新页面。",
  "error.retry": "重试",
  // attribution
  "attribution.link": "致谢与归属",
  "attribution.title": "致谢与归属",
  "attribution.intro": "AI-DER 建立在他人的工作之上。以下列出本运行时所依赖的项目、模型与研究。",
