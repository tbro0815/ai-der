const it: Record<string, string> = {
  ...
  "tier.vram": "VRAM",
  "tier.mmap": "NVMe mappata in RAM",
  "tier.mmapAriaLabel": "Container mappato in RAM: {{res}} di {{total}} GB",
  "tier.disk": "Disco",
  "tier.ariaLabel": "Expert: {{vram}} VRAM, {{disk}} mappati in memoria",
  ...
  "hero.title": "MOTORE AI-DER",
  "hero.subtitle": "Engram distribuiti.",
  "hero.tagline": "Velocità locale.",
  "hero.description": "Connettiti a un server AI-DER locale e ricevi le risposte in streaming direttamente dal tuo hardware. Nulla lascia l'endpoint che scegli.",
  ...
  "chat.placeholder": "Scrivi a AI-DER…",
  "prep.prefix": "Preparazione del motore: calcolo di un prefisso stabile non ancora visto",
  "prep.prompt": "Prefill del prompt",
  "prep.progress": "{{done}} / {{total}} token · {{rate}} tok/s · ~{{eta}} rimanenti",
  "prep.restored": "{{n}} ripristinati dalla cache",
  "prep.waiting": "In attesa del motore…",
  ...
  "error.title": "L'interfaccia AI-DER ha riscontrato un errore",
  "error.hint": "Il motore non è stato coinvolto. Prova a ricaricare la pagina.",
  "error.retry": "Riprova",
  // attribution
  "attribution.link": "Attribuzioni",
  "attribution.title": "Attribuzioni",
  "attribution.intro": "AI-DER è costruito sul lavoro di altri. I crediti qui sotto elencano progetti, modelli e ricerche da cui questo runner dipende.",
  "attribution.close": "Chiudi",
