const de: Record<string, string> = {
  ...
  "sidebar.vllmFastConfirm": "Das Profil fast begrenzt den nutzbaren Kontext auf 64K Token (sonst 131K), solange es gewählt ist. Jeder Client dieser Modell-ID erhält das kleinere Fenster. Trotzdem wählen?",
